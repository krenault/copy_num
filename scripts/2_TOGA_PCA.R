...
### PCA ####
############
gene_copy_data <- read.csv("/Users/katiarenault/PhD/TOGA/loss/Mammalia_all_species_copynumber.csv", row.names = "Gene")
...
#final_metadata <- final_metadata %>% filter(order == "Primates")
